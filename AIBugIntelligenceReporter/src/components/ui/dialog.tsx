  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-xl border border-white/[0.08] bg-[#1c1c21] p-5 shadow-2xl',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md text-white/30 hover:text-white/70 transition-colors focus:outline-none">
        <X className="h-4 w-4" />
